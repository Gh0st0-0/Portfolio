    ...
    return (
        <div className={'contactContainer'}>
            ...
            <div className="form-floating mb-3">
                <input type="email" className="form-control" name="Email" id="Email" placeholder="name@example.com" onChange={HandleChanges} />
                <label htmlFor="Email">Email address</label>
            </div>
            <div className="form-floating mb-3">
                <input type="text" className="form-control" name="Subject" id="Subject" placeholder="Subject" onChange={HandleChanges} />
